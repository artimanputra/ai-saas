...
//                          disabled={isLoading}
//                          placeholder="How do I calculate radius of"
//                          {...field}
//                          />
//                       </FormControl>
//                 </FormItem>
...
const ConversationPage = () => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            // TODO: Handle error state or notify user
        } finally {
            router.refresh();
        }
    };
                ...
                <div className="space-y-4 mt-4">
                    <div className="flex flex-col-reverse gap-y-4">
                        {messages.map((message, index) => (
                            <div key={index} className={`p-4 rounded-lg ${message.role === "user" ? "bg-blue-200" : "bg-green-200"}`}>
                                {message.content}
                            </div>
                        ))}
                    </div>
